...
import multyunits.wochu.com.multyunits.ui.GetFrozenAct;
import multyunits.wochu.com.multyunits.ui.LackQueyAct;
import multyunits.wochu.com.multyunits.ui.OrderLocationAct;


/**
 * Created by Administrator on 2016/2/24.
 */
public class SimpleAdapter2 extends RecyclerView.Adapter<SimpleAdapter2.MyViewHolder> {
    ...
    public SimpleAdapter2(Activity mActivity, List<String> data) {
        this.mActivity = mActivity;
        this.data = data;
        slected = new boolean[data.size()];
    }

    Class[] acts = new Class[]{GetFrozenAct.class, LackQueyAct.class, OrderLocationAct.class};
